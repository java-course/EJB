...
import ru.javacourse.ejb.StateFulBean;
import ru.javacourse.ejb.StateLessBean;
...
public class EjbTest {
    ...
    public void test1() throws Exception {
        StateLessBean bean = (StateLessBean) ctx.lookup("java:global/classes/StateLessBean");
        bean.sayHello();
    ...
    public void test2() throws Exception {
        StateFulBean bean = (StateFulBean) ctx.lookup("java:global/classes/StateFulBean");
